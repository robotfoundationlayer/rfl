...
├── docs/                 # ✅ Docs: getting-started.md + cli-reference.md + authoring-skills.md + authoring-embodiments.md + certifying-a-driver.md (self-certification guide) + design/ (per-increment reference-implementation design records)

...
├── docs/                 # ✅ Docs: getting-started.md + cli-reference.md + certifying-a-driver.md (self-certification guide) + design/ (per-increment reference-implementation design records)

...
├── schemas/              # ✅ Seven JSON schemas + validator (skill-isa, embodiment-descriptor, driver-interface, tactile-manifold/adapter, certificate, extension-registry, epsilon-tolerance — all precisely typed; validate.py = conformance test class 1 with anti-drift invariants C1–C9)

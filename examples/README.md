...
| 02 | `surface-scan/` | Same three | populated (`reach.scan` raster + spiral sweep, `reach.hover`, `sense.inspect`; `skill.yaml` + `skill-spiral.yaml` + `skill-hover.yaml` + 3 descriptors) |
